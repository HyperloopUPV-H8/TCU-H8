...
Pin PF0(PORT_F, PIN_0);
Pin PF1(PORT_F, PIN_1, AF4);
...
Pin PE15(PORT_E, PIN_15, AF1);
Pin PB10(PORT_B, PIN_10);
Pin PB11(PORT_B, PIN_11);
Pin PB12(PORT_B, PIN_12, AF1);
Pin PB13(PORT_B, PIN_13, AF11);
Pin PB14(PORT_B, PIN_14, AF1);
Pin PB15(PORT_B, PIN_15, AF1);
...
Pin PG9(PORT_G, PIN_9);
Pin PG10(PORT_G, PIN_10);
